...
public class Main {
    public static void main(String[] args) {
        ...
        Faculty facultyMember = new Faculty("Tamim", "123 Main Street", "555-1234", "tamim@gmail.com",
                "Building A, Room 101", 60000, hireDate, "9 AM - 5 PM", "Professor");

        Staff partTimeStaff = new PartTime("Samin", "456 Johan State", "555-5678", "samin@gmail.com",
